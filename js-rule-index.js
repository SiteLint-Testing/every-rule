window.siteLintRules = [
  ...
  {
    number: 7,
    ruleId: "applet-missing-body",
    title: "Applets need a text alternative",
    testPage: "",
    docLink: "",
  ...
  {
    number: 28,
    ruleId: "empty-attribute",
    title: "Tooltip content must not be empty",
    testPage: "",
    docLink: "",
  ...
  },
  {
    number: 40,
    ruleId: "h1-only-one",
    title: "There should only be one heading H1 on the page",
    testPage: "",
    docLink: "",
    codeLink: "https://bitbucket.org/sitelint/auditor/src/master/app/rules/auditor/seo/h1-only-one/h1-only-one.ts"
  },
  {
    number: 41,
  ...
  {
    number: 51,
    ruleId: "incorrect-label-placement-for-associated-input",
    title: "The HTML label element must be positioned properly relative to its associated form input element",
    testPage: "",
    docLink: "",
    codeLink: "https://bitbucket.org/sitelint/auditor/src/master/app/rules/wcag2/1/1.3/1.3.1/H44/incorrect-label-placement.ts"
  },
