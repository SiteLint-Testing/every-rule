window.siteLintPages = [
  ...
  { value: "landmarks-none.html", label: "66. landmarks none" },
  { value: "legend-first-child-of-fieldset.html", label: "67. legend first child of fieldset" },
  { value: "label-visually-hidden-only.html", label: "68. label visually hidden only" },
  ...
  { value: "minimum-font-size.html", label: "78. minimum font size" },
  { value: "missing-alt-attribute.html", label: "79. missing alt attribute" },
  { value: "missing-href.html", label: "80. missing href" },
  { value: "missing-label.html", label: "81. missing label" },
  { value: "missing-submit-button.html", label: "82. missing submit button" },
  { value: "misused-aria.html", label: "83. misused aria" },
  { value: "misused-input-attribute.html", label: "84. misused input attribute" },
  { value: "misused-required-attribute.html", label: "85. misused required attribute" },
  { value: "misused-tabindex-attribute.html", label: "86. misused tabindex attribute" },
  ...
  { value: "multiple-languages.html", label: "119. multiple languages" }
];